...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-alg-015-are-all-groups-surjunctive-485be9f1-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/ALG-015"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-alg-015-are-all-groups-surjunctive-485be9f1-v1",
      "problem_contract_sha256": "3c7e471ec75a5ef82a0c256b70c38a3a7152a03be55128f38c5aebacb44d0189",
      "problem_id": "problem:um-alg-015-are-all-groups-surjunctive-485be9f1",
      "route_id": "route:um-alg-015-are-all-groups-surjunctive-485be9f1-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-alg-015-are-all-groups-surjunctive-485be9f1-source-fidelity-01",
      "graph_id": "graph:um-alg-015-are-all-groups-surjunctive-485be9f1-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-alg-015-are-all-groups-surjunctive-485be9f1-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-alg-015-are-all-groups-surjunctive-485be9f1-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is every group surjunctive? That is, for any group $G$, if $\\phi: A^G \\to A^G$ is a cellular automaton that is injective, must it also be surjective?"
          },
          "statement_sha256": "c46733c3d6240af753a22b811ac846bad502915c328e2e062358b3665a6f5bfb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-alg-015-are-all-groups-surjunctive-485be9f1-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-alg-015-are-all-groups-surjunctive-485be9f1-root",
      "route_id": "route:um-alg-015-are-all-groups-surjunctive-485be9f1-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Algebra problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-alg-015-dd1c16aec331",
        "url": "https://www.unsolvedmath.com/problems/ALG-015"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
